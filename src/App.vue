<template>
  <div id="app">
    <h1 style="margin-top: 100px">当前系统 {{userOs}}
     <i @click="changeOs" style="font-size: 15px" class="el-icon-sort"></i>
    <a href="https://github.com/VGEAREN/win-mac-keymap" style="margin-left: 20px;">
      <svg width="15px" height="13px" viewBox="0 0 256 250" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
      <g>
